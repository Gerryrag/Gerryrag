```aura width=860 height=200
 ...
 border: '1px solid rgba(110,80,220,0.18)'
  ...
  <div style={{
    ...
    <img src={github?.user?.avatarUrl ?? 'https://github.com/Gerryrag.png'} width={88} height={88} style={{ borderRadius: 44 }} />
  </div>
  ...
  <div style={{ display:'flex', flexDirection:'column', marginLeft:168, gap:8, zIndex: 10 }}>
    ...
    <div style={{ display:'flex', gap:8, marginTop:6 }}>
      {['HTML5', 'CSS3', 'PHP', 'Laravel', 'Photoshop'].map(function(tag) {
        return (
          <div key={tag} style={{
...
(function() {
 var categories = [
   { title: 'Languages', color: '#a78bfa', items: ['PHP', 'JavaScript', 'HTML5', 'CSS3'] },
   { title: 'Tools & Libs', color: '#60a5fa', items: ['Laravel', 'Bootstrap', 'Photoshop'] },
 ];
...
```aura width=130 height=44 link="https://www.linkedin.com/in/gerryrag" inline align=center
<SocialMediaButton
...
/>
```
```aura width=130 height=44 link="https://www.youtube.com/@Gerryrag" inline align=center
<SocialMediaButton
  ...
  height={44}
  gradientStops={[
    { offset: '0%', color: '#fe5e5e' },
    { offset: '30%', color: '#000000' },
    { offset: '60%', color: '#ff2e2e' },
    { offset: '80%', color: '#000000' },
    { offset: '100%', color: '#ff8e8e' },
  ]}
/>
```
```aura width=142 height=44 link="https://www.instagram.com/gerryrag" inline align=center
<SocialMediaButton
